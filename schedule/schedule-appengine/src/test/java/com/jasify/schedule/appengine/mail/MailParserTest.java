...
public class MailParserTest {
    ...
    public void testJasifySubscriptionEmailAsText() throws Exception {
        MailParser mailParser = MailParser.createJasifySubscriptionEmail(Arrays.asList(new Subscription[]{subscription1, subscription2}));
        String text = mailParser.getText();
    ...
    public void testSubscriberSubscriptionEmailAsText() throws Exception {
        MailParser mailParser = MailParser.createSubscriberSubscriptionEmail(Arrays.asList(new Subscription[]{subscription1, subscription2}));
        String text = mailParser.getText();
