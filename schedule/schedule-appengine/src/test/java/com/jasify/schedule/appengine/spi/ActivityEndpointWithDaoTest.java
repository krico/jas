...
public class ActivityEndpointWithDaoTest {
    ...
    public class PriceRandomizer implements Randomizer<Double> {
        @Override
    ...
    public class MaxCountRandomizer implements Randomizer<Integer> {
        @Override
    ...
    private Organization createOrganization(boolean store) {
        Populator populator = new PopulatorBuilder().build();
        Organization organization = populator.populateBean(Organization.class, "id", "organizationMemberListRef", "lcName");
        organization.setLcName(StringUtils.lowerCase(organization.getName()));
        if (store) {
    ...
    private ActivityType createActivityType(Organization organization, boolean store) {
    ...
    private ActivityPackage createActivityPackage(Organization organization, boolean store) {
        PopulatorBuilder populatorBuilder = new PopulatorBuilder();
    ...
    private Activity createActivity(Organization organization, boolean store) {
        ...
        return createActivity(activityType, store);
    }

    private Activity createActivity(boolean store) {
        return createActivity(createOrganization(true), store);
    }

    private ActivityPackage createActivityPackage(boolean store) {
        return createActivityPackage(createOrganization(true), store);
    }
    ...
    // GetActivityTypes
    @Test
    public void testGetActivityTypesKeyNotFound() throws Exception {
        thrown.expect(NotFoundException.class);
        endpoint.getActivityTypes(newCaller(1), Datastore.allocateId(Organization.class));
    }

    @Test
    public void testGetActivityTypesForUnknownOrganizationId() throws Exception {
        thrown.expect(NotFoundException.class);
        endpoint.getActivityTypes(newCaller(1), Datastore.allocateId(Organization.class));
    }
    ...
    @Test
    public void testGetActivityTypeNullKey() throws Exception {
        thrown.expect(NotFoundException.class);
    ...
    @Test
    public void testGetActivityTypeForUnknownKey() throws Exception {
        thrown.expect(NotFoundException.class);
    ...
    @Test
    public void testUpdateActivityTypeNullKey() throws Exception {
        thrown.expect(NotFoundException.class);
        thrown.expectMessage("Not found");
    ...
    @Test
    public void testUpdateActivityTypeWithUnknownKey() throws Exception {
        thrown.expect(NotFoundException.class);
        Organization organization = createOrganization(true);
        ActivityType activityType = createActivityType(organization, true);
    ...
    public void testAddActivityTypeUnknownOrganizationId() throws Exception {
        thrown.expect(NotFoundException.class);
        JasAddActivityTypeRequest jasAddActivityTypeRequest = new JasAddActivityTypeRequest();
        jasAddActivityTypeRequest.setActivityType(createActivityType(createOrganization(false), false));
        jasAddActivityTypeRequest.setOrganizationId(Datastore.allocateId(Organization.class));
        endpoint.addActivityType(newAdminCaller(1), jasAddActivityTypeRequest);
    }
    ...
    public void testAddActivityTypeDuplicate() throws Exception {
        Organization organization = createOrganization(true);
        ActivityType activityType = createActivityType(organization, false);
        thrown.expect(BadRequestException.class);
    ...
    // RemoveActivityType
    @Test
    public void testRemoveActivityTypeNulUser() throws Exception {
        thrown.expect(UnauthorizedException.class);
        thrown.expectMessage("Only authenticated users can call this method");
    ...
    @Test
    public void testRemoveActivityTypeNullKey() throws Exception {
        thrown.expect(NotFoundException.class);
        thrown.expectMessage("Not found");
    ...
    @Test
    public void testRemoveActivityTypeUnknownKey() throws Exception {
        thrown.expect(NotFoundException.class);
    ...
    public void testRemoveActivityType() throws Exception {
        ActivityType activityType = createActivityType(createOrganization(true), true);
    ...
    @Test
    public void testGetActivityNullKey() throws Exception {
        thrown.expect(NotFoundException.class);
        thrown.expectMessage("Not found");
    ...
    @Test
    public void testGetActivityUnknownKey() throws Exception {
        thrown.expect(NotFoundException.class);
    ...
    @Test
    public void testUpdateActivityNullKey() throws Exception {
        thrown.expect(NotFoundException.class);
        thrown.expectMessage("Not found");
    ...
    @Test
    public void testUpdateActivityUnknownKey() throws Exception {
        thrown.expect(NotFoundException.class);
    ...
    public void testUpdateActivity() throws Exception {
        ...
        Activity activity2 = createActivity(activity1.getActivityTypeRef().getModel(), false);
    ...
    @Test
    public void testRemoveActivityNullKey() throws Exception {
        thrown.expect(NotFoundException.class);
        thrown.expectMessage("Not found");
    ...
    @Test
    public void testRemoveActivityWithUnknownKey() throws Exception {
        thrown.expect(NotFoundException.class);
    ...
    @Test
    public void testGetSubscriptionsNullKey() throws Exception {
        thrown.expect(NotFoundException.class);
        thrown.expectMessage("Not found");
    ...
    @Test
    public void testGetSubscriptionsUnknownKey() throws Exception {
        thrown.expect(NotFoundException.class);
    ...
    @Test
    public void testCancelSubscriptionNullKey() throws Exception {
        thrown.expect(NotFoundException.class);
        thrown.expectMessage("Not found");
    ...
    @Test
    public void testCancelSubscriptionUnknownKey() throws Exception {
        thrown.expect(NotFoundException.class);
    ...
    // GetActivityPackages
    @Test
    public void testGetActivityPackagesNullOrganisationId() throws Exception {
        thrown.expect(NotFoundException.class);
        thrown.expectMessage("Not found");
    ...
    @Test
    public void testGetActivityPackagesUnknownOrganisationId() throws Exception {
        thrown.expect(NotFoundException.class);
        endpoint.getActivityPackages(null, Datastore.allocateId(Organization.class));
    }
    ...
    @Test
    public void testUpdateActivityPackageNulUser() throws Exception {
        thrown.expect(UnauthorizedException.class);
        thrown.expectMessage("Only authenticated users can call this method");
    ...
    @Test
    public void testUpdateActivityPackageNullKey() throws Exception {
        thrown.expect(NotFoundException.class);
        thrown.expectMessage("Not found");
    ...
    @Test
    public void testUpdateActivityPackageUnknownKey() throws Exception {
        thrown.expect(NotFoundException.class);
        JasActivityPackageRequest jasActivityPackageRequest = new JasActivityPackageRequest();
        jasActivityPackageRequest.setActivityPackage(new ActivityPackage());
        endpoint.updateActivityPackage(newAdminCaller(1), Datastore.allocateId(ActivityPackage.class), jasActivityPackageRequest);
    ...
    public void testAddActivityPackageNullNullActivities() throws Exception {
        ...
        activityPackage.getOrganizationRef().setModel(createOrganization(true));
    ...
    public void testAddActivityPackageUnknownOrganizationId() throws Exception {
        ...
        JasActivityPackageRequest jasActivityPackageRequest = new JasActivityPackageRequest();
        Organization organization = createOrganization(true);
        ActivityPackage activityPackage = createActivityPackage(null, true);
    ...
    @Test
    public void testRemoveActivityPackageNulUser() throws Exception {
        thrown.expect(UnauthorizedException.class);
        thrown.expectMessage("Only authenticated users can call this method");
    ...
    @Test
    public void testRemoveActivityPackageNullKey() throws Exception {
        thrown.expect(NotFoundException.class);
        thrown.expectMessage("Not found");
    ...
    @Test
    public void testGetActivityPackageActivitiesNullActivityPackageId() throws Exception {
        thrown.expect(NotFoundException.class);
        endpoint.getActivityPackageActivities(null, null);
    }

    @Test
    public void testGetActivityPackageActivitiesUnknownActivityPackageId() throws Exception {
        thrown.expect(NotFoundException.class);
