...
public final class ServletTestHelper {
    ...
    public static InvocationContext expectResponse(ServletUnitClient client, WebRequest request, int responseType) throws IOException, ServletException {
        return expectResponse(client, request, responseType, null);
    }

    public static InvocationContext expectResponse(ServletUnitClient client, WebRequest request, int responseType, String responseMessage) throws IOException, ServletException {
